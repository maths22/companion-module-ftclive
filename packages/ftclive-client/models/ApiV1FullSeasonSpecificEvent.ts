...
export class ApiV1FullSeasonSpecificEvent {
    'matchList'?: ApiSeasonSpecificMatchDetailedList;
    'elimsMatchList'?: ApiSeasonSpecificMatchDetailedList;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "matchList",
            "baseName": "matchList",
            "type": "ApiSeasonSpecificMatchDetailedList",
            "format": ""
        },
        {
            "name": "elimsMatchList",
    ...
    static getAttributeTypeMap() {
        return ApiV1FullSeasonSpecificEvent.attributeTypeMap;
    }
