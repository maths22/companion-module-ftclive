...
export class ApiV2FullEvent {
    'version'?: ApiV1Version;
    'event'?: ApiV1Event;
    'teamList'?: ApiV1TeamDetailedList;
    'teamStatusInfo'?: ApiV1StatusList;
    'rankingsList'?: ApiV1RankingList;
    'combinedRankingsList'?: ApiV1RankingList;
    'matchList'?: ApiV1MatchDetailedList;
    'allianceList'?: ApiV1ElimsAllianceList;
    'elimsMatchList'?: ApiV1ElimsMatchList;
    'elimsMatchDetailedList'?: ApiV1MatchDetailedList;
    'awardList'?: ApiV2AwardList;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "teamList",
            "baseName": "teamList",
            "type": "ApiV1TeamDetailedList",
            "format": ""
        },
        {
            "name": "teamStatusInfo",
            "baseName": "teamStatusInfo",
            "type": "ApiV1StatusList",
            "format": ""
        },
        {
            "name": "rankingsList",
            "baseName": "rankingsList",
            "type": "ApiV1RankingList",
            "format": ""
        },
        {
            "name": "combinedRankingsList",
            "baseName": "combinedRankingsList",
            "type": "ApiV1RankingList",
            "format": ""
        },
        {
            "name": "matchList",
            "baseName": "matchList",
            "type": "ApiV1MatchDetailedList",
            "format": ""
        },
        {
            "name": "allianceList",
            "baseName": "allianceList",
            "type": "ApiV1ElimsAllianceList",
            "format": ""
        },
        {
            "name": "elimsMatchList",
            "baseName": "elimsMatchList",
            "type": "ApiV1ElimsMatchList",
            "format": ""
        },
        {
            "name": "elimsMatchDetailedList",
            "baseName": "elimsMatchDetailedList",
            "type": "ApiV1MatchDetailedList",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return ApiV2FullEvent.attributeTypeMap;
    }
