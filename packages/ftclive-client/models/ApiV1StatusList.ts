...
export class ApiV1StatusList {
    'activeStatusTypes'?: Array<ApiV1StatusType>;
    'teamStatusList'?: Array<ApiV1TeamStatus>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "activeStatusTypes",
            "baseName": "activeStatusTypes",
            "type": "Array<ApiV1StatusType>",
            "format": ""
        },
        {
            "name": "teamStatusList",
            "baseName": "teamStatusList",
            "type": "Array<ApiV1TeamStatus>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiV1StatusList.attributeTypeMap;
    }
