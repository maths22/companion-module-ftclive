...
export class ApiV1MatchBrief {
    'matchName'?: string;
    'matchNumber': number;
    'field': number;
    'red'?: ApiV1MatchBriefRed;
    'blue'?: ApiV1MatchBriefRed;
    'finished': boolean;
    'matchState'?: string;
    /**
    * If the matchState is COMMITTED then this is the time of the most recent commit. Otherwise, this is the time that the match schedule was created.
    */
    'time': number;
    ...
    static getAttributeTypeMap() {
        return ApiV1MatchBrief.attributeTypeMap;
    }
