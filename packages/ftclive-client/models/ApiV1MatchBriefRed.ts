...
/**
* ApiV1QualsAlliance if this match is a qualification match or ApiV1ElimsAlliance if this match is an eliminations match.
*/
/**
 ...
 * @export
 */
export type ApiV1MatchBriefRed = ApiV1ElimsAlliance | ApiV1QualsAlliance;

/**
* @type ApiV1MatchBriefRedClass
    * ApiV1QualsAlliance if this match is a qualification match or ApiV1ElimsAlliance if this match is an eliminations match.
* @export
*/
export class ApiV1MatchBriefRedClass {
