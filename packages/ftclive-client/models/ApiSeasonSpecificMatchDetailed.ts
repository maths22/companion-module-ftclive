...
export class ApiSeasonSpecificMatchDetailed {
    'matchBrief'?: ApiV1MatchBrief;
    'startTime': number;
    'scheduledTime': number;
    'resultPostedTime': number;
    'redScore': number;
    'blueScore': number;
    'red'?: ApiV1IntoTheDeepScoreBreakdown;
    'blue'?: ApiV1IntoTheDeepScoreBreakdown;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "resultPostedTime",
            "baseName": "resultPostedTime",
            "type": "number",
            "format": "int64"
        },
        {
        ...
        },
        {
            "name": "red",
            "baseName": "red",
            "type": "ApiV1IntoTheDeepScoreBreakdown",
            "format": ""
        },
        {
            "name": "blue",
    ...
    static getAttributeTypeMap() {
        return ApiSeasonSpecificMatchDetailed.attributeTypeMap;
    }
