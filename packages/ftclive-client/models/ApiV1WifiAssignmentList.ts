...
export class ApiV1WifiAssignmentList {
    'assignments'?: Array<ApiV1WifiAssignment>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "Array<ApiV1WifiAssignment>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiV1WifiAssignmentList.attributeTypeMap;
    }
