...
export class ApiV1Ranking {
    'team': number;
    'teamName'?: string;
    'ranking': number;
    /**
    * only populated at league meets
    */
    'leagueRanking': number;
    /**
    * the formatted decimal average Ranking Points
    */
    'rankingPoints'?: string;
    /**
    * the formatted decimal average TBP1
    */
    'tbp1'?: string;
    /**
    * the formatted decimal average TBP2
    */
    'tbp2'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "leagueRanking",
            "baseName": "leagueRanking",
            "type": "number",
            "format": "int32"
        },
        {
            "name": "rankingPoints",
            "baseName": "rankingPoints",
            "type": "string",
            "format": ""
        },
        {
        ...
        {
            "name": "matchesPlayed",
            "baseName": "matchesPlayed",
            "type": "number",
            "format": "int32"
        },
        {
            "name": "highestScore",
            "baseName": "highestScore",
            "type": "number",
            "format": "int32"
        },
        {
    ...
    static getAttributeTypeMap() {
        return ApiV1Ranking.attributeTypeMap;
    }
