...
export class ApiV1Error {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "printStackTrace",
            "type": "any",
            "format": ""
        },
        {
            "name": "fillInStackTrace",
            "baseName": "fillInStackTrace",
            "type": "Throwable",
            "format": ""
        },
        {
            "name": "getStackTrace",
            "baseName": "getStackTrace",
            "type": "Array<StackTraceElement>",
            "format": ""
        },
        {
            "name": "setStackTrace",
            "baseName": "setStackTrace",
            "type": "any",
            "format": ""
        },
        {
            "name": "addSuppressed",
            "baseName": "addSuppressed",
            "type": "any",
            "format": ""
        },
        {
            "name": "getSuppressed",
            "baseName": "getSuppressed",
    ...
    static getAttributeTypeMap() {
        return ApiV1Error.attributeTypeMap;
    }
