...
export class ApiSeasonSpecificMatchDetailedList {
    'matches'?: Array<ApiSeasonSpecificMatchDetailed>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "matches",
            "baseName": "matches",
            "type": "Array<ApiSeasonSpecificMatchDetailed>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiSeasonSpecificMatchDetailedList.attributeTypeMap;
    }
