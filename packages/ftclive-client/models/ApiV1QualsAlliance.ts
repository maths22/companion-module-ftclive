...
export class ApiV1QualsAlliance {
    'team1': number;
    'team2': number;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "isTeam1Surrogate",
            "baseName": "isTeam1Surrogate",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "isTeam2Surrogate",
            "baseName": "isTeam2Surrogate",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiV1QualsAlliance.attributeTypeMap;
    }
