...
export class ApiV2AwardAssignment {
    /**
    * The first name of the winner of an individual award.
    */
    'firstName'?: string;
    /**
    * The last name of the winner of an individual award.
    */
    'lastName'?: string;
    /**
    * The place of this assignment. 1 = 1<sup>st</sup>, etc. For non-ordered awards, this is the order the names were entered.
    */
    'series': number;
    /**
    * The winning team of the award, or the team the individual is affiliated with.
    */
    'team': number;
    ...
    static getAttributeTypeMap() {
        return ApiV2AwardAssignment.attributeTypeMap;
    }
